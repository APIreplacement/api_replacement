...
public class ResolveExternalMethodInvocations {
     ...
     *                                                      This data can be prepared using {@link MavenUtils.helper.JarExtractedClassAndPackageCSVReader#Load_LibNameAsKey}
     * @param projectDependencies_extractedClasses_byClass  (optional) Needed if linkToNonDependencyIfNeeded=true
     *                                                      This data can be prepared using {@link MavenUtils.helper.JarExtractedClassAndPackageCSVReader#Load_DataAsKey}
